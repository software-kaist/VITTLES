...
public class ReceiveMessageServer extends AsyncTask<Void, String, Void> {
	...
	public static final int STOP_IR_SIGNAL = 4;

	public ReceiveMessageServer(Context context, Handler handler){
		mContext = context;
        mHandler = handler;
	}
	...
	protected Void doInBackground(Void... params) {
		try {
			...
			while(true){
				...
				//makeMessage(SIMSOCK_DISCONNECTED, "");
